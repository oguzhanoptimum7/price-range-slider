$('.slider').each(function(e) {
  ...
  data.min = $(".slider").data("min");
  data.max = $(".slider").data("max");
  ...
  slider.slider({
    ...
    slide(event, ui) {
      ...
      $(slider.data('input-min')).val(ui.values[0].toString());
      $(slider.data('input-max')).val(ui.values[1].toString());
